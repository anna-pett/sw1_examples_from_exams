...
public class Tester {
	public static void main(String args[]) {
		...
		class DataItems2Breach extends DataItems2{
			...
			DataItems2Breach d2Breach = new DataItems2Breach(Arrays.asList("a", "b"));
			...
			DataItems3.DataItems3Nested d3Breach = new DataItems3.DataItems3Nested(Arrays.asList("a", "b"));
